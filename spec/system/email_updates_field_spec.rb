...
#  UserField.all.destroy_all
  user_field = UserField.find_or_create_by(name: SiteSetting.discourse_sync_to_custom_field_custom_email_field, field_type: "text",
    editable: true, show_on_profile: true, description: "Email")
  before do
